...
| 2026-06-14 | Next-level study batch added: HORMA / MemoPilot / MMPO / Memory-R2 | All four are RL-trained memory policies from May–June 2026 and directly extend or critique Memory-R1. Reading guide in `next-level-study-index.md`. | End of one-week reading block — re-evaluate whether any changes the Phase 1B official-baseline choice or the mechanism direction. |
| | | | |
